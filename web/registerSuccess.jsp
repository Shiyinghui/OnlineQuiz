...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/success-main.css">
    <script src="https://code.jquery.com/jquery-2.2.3.min.js"   integrity="sha256-a23g1Nt4dtEYOj7bR+vTu7+T8VP13humZFBJNIYoEJo="   crossorigin="anonymous"></script>
    <script src="js/success-moveit.js"></script>
    <script src="js/success-main.js"></script>
        <%--<title>注册成功</title>--%>

</head>
<body>
<button class="succeed">Click me to Succeed</button>
<div class="success-modal">
            ...
            <svg width="580" height="400" xmlns="http://www.w3.org/2000/svg">
                ...
                <g>
                    ...
                    <g id="popGroup">
                        ...
                        <line transform="rotate(-180 285.5,299.99072265625) " stroke="#fff" stroke-linecap="butt" stroke-linejoin="null" id="svg_6" y2="289.981489" x2="285.5" y1="310" x1="285.5" fill-opacity="null" stroke-opacity="null" stroke-width="5" fill="none"></line>
    ...
    <div class="info">
        ...
        <div class="text">You did a great job and now you should celebrate!</div>
        <button class="continue"><i class="ion-android-arrow-forward"></i> Continue</button>
    </div>
</div>
<%--<p>注册成功！</p>--%>
